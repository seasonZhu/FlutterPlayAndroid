...
class CustomRoute extends PageRouteBuilder {
  ...
  static Route ios(Widget widget, BuildContext context, {bool fullscreenDialogfalse = false}) {
    return CupertinoPageRoute(
      fullscreenDialog: fullscreenDialogfalse,
  ...
  static Route android(Widget widget, BuildContext context,
      {bool fullscreenDialogfalse = false}) {
