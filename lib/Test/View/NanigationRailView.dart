...
class NanigationRailView extends StatefulWidget {
  @override
  NanigationRailViewState createState() => NanigationRailViewState();
}


class NanigationRailViewState extends State<NanigationRailView>    {
