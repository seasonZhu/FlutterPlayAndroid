...
extension Request on HttpUtils {
  ...
  // 通过id与page获取单个分类的列表
  static Future<SearchResultResponse> getProjectClassifyList({int page, int id}) async {
    Map<String, String> params = Map();
    params["cid"] = id.toString();
    var json = await HttpUtils.post(api: Api.getProjectClassifyList + page.toString() + "/json", params: params);
    return SearchResultResponse.fromJson(json);
  }
